          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Work List</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            {/* <li className="text-red-500 ">
              <form
                ...
                className="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 group cursor-pointer"
              >
